...
class _EncodeBlockBlueGreen(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.layer = nn.Sequential(_BlueBlock(in_channels, 32), _GreenBlock(32, out_channels, 1))
...
class _EncodeBlockGreenGreen(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.layer = nn.Sequential(
            _GreenBlock(in_channels, 2 * in_channels, 2), _GreenBlock(2 * in_channels, out_channels, 1)
        )
